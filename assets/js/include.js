    ...
    try {
        ...
        if (headerPlaceholder) {
            ...
            if (headerResponse.ok) {
                ...
                const dropdownItems = [
                    { page: 'Short_conversation.html', selector: 'a[href="../templates/Short_conversation.html"]' },
                    { page: 'Long_conversation.html', selector: 'a[href="../templates/Long_conversation.html"]' },
                    { page: 'Advertisement.html', selector: 'a[href="../templates/Advertisement.html"]' },
                    { page: 'Product.html', selector: 'a[href="../templates/Product.html"]' },
                    { page: 'News_report.html', selector: 'a[href="../templates/News_report.html"]' },
                    { page: 'Article.html', selector: 'a[href="../templates/Article.html"]' },
                    { page: 'Text_completion.html', selector: 'a[href="../templates/Text_completion.html"]' },
                    { page: 'Paragraph.html', selector: 'a[href="../templates/Paragraph.html"]' }
                ];
